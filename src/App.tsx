...
function VisitorTracker() {
  ...
  useEffect(() => {
    api.registerVisit(location.pathname);
  }, [location.pathname]);
  return null;
}
      ...
      <Router>
        ...
        <div className="min-h-screen flex flex-col">
          ...
          <a
            ...
            className="fixed bottom-24 left-6 z-40 w-12 h-12 rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110"
            style={{
              background: '#25D366',
